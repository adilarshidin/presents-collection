...
const About = () => {
  return (
    <ViewWrapper>
      ...
      <p>Está caracterizada por el uso de ángulos rectos, que se elevan hasta el cielo. En el interior se obtiene la luz a través de celosías de vidrio y plástico. El material más utilizado es el hormigón, tanto para la realización de los triángulos exteriores como para la plataforma del coro.</p>
      <Map />
    </ViewWrapper>
  );
};
